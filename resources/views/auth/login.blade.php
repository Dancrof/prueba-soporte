        ...
        <div id="corewidgetbox" class="wid">
            ...
            <div id="wbox" class="widgetrow text-center">
                ...
                <span onclick="javascript: window.location.href='{{url('auth/register')}}';">
                    <a href="{{url('auth/register')}}"  class="widgetrowitem defaultwidget"  style="background-image:url('{{ asset('lb-faveo/media/images/register.png') }}');"  >
                    ...
                    @if($system->status) 
                        @if($system->status == 1)
                            <span onclick="javascript: window.location.href='{!! URL::route('form') !!}';">
                                <a href="{!! URL::route('form') !!}" class="widgetrowitem defaultwidget" style="background-image:url('{{ asset('lb-faveo/media/images/submitticket.png') }}');">
                                    <div class="widgetitemtitle">{!! Lang::get('lang.submit_a_ticket') !!}</div>
                                </a>
                            </span>
                        @endif
                    @endif
                ...
                <span onclick="javascript: window.location.href='{{url('mytickets')}}';">
                    <a href="{{url('mytickets')}}" class="widgetrowitem defaultwidget" style="background-image:url('{{ asset('lb-faveo/media/images/news.png') }}');">
                        <span class="widgetitemtitle">{!! Lang::get('lang.my_tickets') !!}</span>
                    </a>
                </span>
                <span onclick="javascript: window.location.href='{{url('/knowledgebase')}}';">
                    <a href="{{url('/knowledgebase')}}" class="widgetrowitem defaultwidget" style="background-image:url('{{ asset('lb-faveo/media/images/knowledgebase.png') }}');">
                        ...
                        <h4 style="background-color:rgb(93, 201, 120);">
                            ...
                            @if(isset($company->logo) && $company->use_logo == 1)
                                <a href="{{ $company->website }}" class="logo" target="_blank">
                                    <img src="{{ asset('uploads/company/'.$company->logo) }}" width="100px;">
                                </a>
                            @else
